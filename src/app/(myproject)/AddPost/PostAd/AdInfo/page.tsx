            ...
            <div className='flex items-center justify-between'>
                <form className='bg--300 w-full'>
                    <div className='mb-4  w-full'>
                        <label htmlFor="adTitle" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white"><h4>Add Title*</h4></label>
                    ...
                    <div className='mb-4  w-full'>
                        <label htmlFor="category" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white"><h4>Category*</h4></label>
                    ...
                    <Link href={'/AddPost/PostAd/AdDetails'}><button type="submit" className="btn mt-3 main-btn ">Next Step</button>
                    </Link>
                </form>
